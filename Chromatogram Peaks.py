...
#######This section is for  reading the given chromatogram file (superose6_50.asc)#######
...
#####This section tries to find the boundaries by slipping off of each peak and reaching the boundaries through considering two conditions:##### 
